...
|*Beschreibung* |
Die Werte der Voreinstellungen (Studiengang, Uhrzeit, Datum) werden aus einem festgelegten Wertebereich gewählt. Realisiert wird dies durch Dropdown-Menüs und einen Datepicker. Offensichtlich wird also erwartet, dass die Voreinstellungen nicht durch Freitextfelder erfasst werden können. (manueller Test)
...
|*Nachbedingung*
a| * Dozent befindet sich auf Voreinstellungsseite mit ausgewählten Einstellungen
...
|*Beschreibung* | 
Die auswählbaren Werte der Voreinstellungsmenüs beziehen sich auf feste Wertebereiche. Erwartet wird, dass alle Eingabemöglichkeiten valide sind. (manueller Test)
...
|*Beschreibung* |
Die Anwendung sollte nutzerfreundlich und leicht erfassbar sein. Erwartet wird deswegen, dass eine themenfremde Person die Anwendung (bezogen auf einen Buchungsdurchlauf) ohne Hilfe durch Dritte nutzen kann. (manueller Test)
...
|*Beschreibung* |
Der Buchungsprozess sollte unkompliziert und gut orientiert sein. Es wird deshalb erwartet, dass die erfolgreiche Buchung eines Experiments mit 15 Klicks oder weniger passieren kann. (manueller Test)
