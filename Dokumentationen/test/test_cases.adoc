...
|*Beschreibung* |Der Dozent versucht bewusst falsche Eingaben in den Voreinstellungen zu treffen. Falsche Eingaben sind ein Datum in der Vergangenheit oder eine fehlerhafte Werte für die Zeit.
...
==== TC18 - Dozentenwoche für einen Dozenten wird korrekt angezeigt
