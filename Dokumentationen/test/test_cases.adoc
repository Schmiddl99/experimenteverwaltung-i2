...
|*Beschreibung* |Es muss sichergestellt werden, dass der Admin keinen Zugriff auf das Dozenten-Journal hat, die Dozenten nur ihr persönliches Journal einsehen dürfen und nur der Admin die Statistik abrufen kann. Auch dürfen die Dozenten nur ihre eigene Dozentenwoche abrufen. 
...
|*Nachbedingung*
a| * Admin hat keinen Zugriff auf beliebiges Journal 
* Dozent kann kein fremdes Journal einsehen
* Dozent kann die Statistik nicht aufrufen
...
|*Beschreibung* |Nach einem Internetausfall müssen die Anwenderdaten noch abrufbar sein. 
...
|*Beschreibung* |Es darf zu keinem Zeitpunkt Schaltflächen geben, die denselben Zweck erfüllen oder dieselbe Funktion aufrufen. 

|*Vorbedingungen und benötigte Daten*
a| * Admin ist angemeldet
* Dozent ist angemeldet
* es existiert mindestens ein Experiment
* es existiert mindest eine Buchung
