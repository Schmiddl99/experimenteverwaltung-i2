...
|*Beschreibung* | 
Die auswählbaren Werte der Auswahlungsmenüs beziehen sich auf feste Wertebereiche. Erwartet wird, dass alle Eingabemöglichkeiten valide sind. (manueller Test)
