...
** Das Gruppen- und Arbeitsklima ist im grünen Bereich. 
* Lesson Learned
** Das Inkrement so spät durchzuführen hat sich als Fehler erwiesen. Wir waren uns zwar sicher, dass wir mit den Wireframes und der Vorführung die endgültige Zustimmung des Kunden erreicht hätte, dem war aber leider nicht so. Wir mussten leider feststellen, dass der Kunden als er sich mit der Sotware allein beschäftigte, im nochmals Änderungswünsche eingefallen sind. In dieser Situation wäre es sicher besser gewesen, mit dem Kunden viele kleine Inkremente durchzuführen. 