...
Die TCs mussten dementsprechend auch abgeändert werden und der TC WELCHER ???? wurde für AW01 neu erstellt.
...
Die Installation des Systems wurde am 28.06.2021 von unsrem Devolper {rb} durchgeführt und konnte erfolgreich, ohne Probleme abgeschlossen werden. 