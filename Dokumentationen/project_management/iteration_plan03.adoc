...
* Ziel positives Feedback des Coaches zu den System Wide Requirements
...
* Der Kunde hat die ihm vorgelegten Wireframes bestätigt. Jede mögliche Usecase wurde mit einem Wireframe abgedeckt. 
