...
* Ziel: LCA-Meilenstein - Ende der Elaboration Phase, wurde NICHT erreicht, IOC Meilenstein wurde erfolgreich begonnen.
...
*** *Erfolgskriterien:* Use Case 01 wurde erfolgreich implementiert und liegt in GitHub funktionstüchtig vor. Desweiteren wurde er der Gruppe forgeführt, dass nun die Beta Tests begonnen werden können. Wir sehen diesen Punkt als erfüllt an. 
...
** *Understand:* 
*** Besserer Informationsaustausch der Gruppen in bezug auf "Schaffe ich meinen Workload". Durch früheres melden von Problemen, hätte das Team früher reagieren können und dadurch vielleicht die Aufgaben anderst verteilt oder die Priorisierung geändert. 
| a|
* *Überprüfung selbst gesteckter Iterationsziele: Y/N (5/6)*
...
** Das C4 Modell wurde um Use Case 03 erweitert *Y*
...
* Unsere Arbeitsschätzungen betrachten wir als GUT obwohl, nicht alle Iterationsziele erreicht werden konnten. Dies begründen wir mit dem oben beschriebenen Corona Umständen. Dennoch werden wir nun unserer Planung für die nächste Iteration unsere Plannung überdenken und die Arbeitskäfte besser verteilen. 
