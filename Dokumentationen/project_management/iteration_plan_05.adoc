...
| LCA Meilenstein wird übarbeitet und abgeschlossen    | 21.01.2021
| Vorbereitungen für IOC Meilenstein wird abgeschlossen | 21.01.2021
|===
...
* Besuch des Ruby on Rails Workshops durch alle Gruppenmitgleider
...
* TCs überarbeiten und Testdaten formulieren 
* C4 Modell für UC01
* Entscheidung fällen bezüglich eines selbstentwickelten Logins oder des zurückgreifens auf den HTW Login  
