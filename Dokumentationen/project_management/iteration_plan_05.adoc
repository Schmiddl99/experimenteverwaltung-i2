...
| TS-M4 | 27.04.2021
| Ruby on Rails Update| xxxxxx
| LCA Meilenstein wird übarbeitet und abgeschlossen    | 05.05.2021
| Vorbereitungen für IOC Meilenstein wird abgeschlossen | 50.05.2021
|===
...
|Risklist Update: Alte TCs könnten nicht funktionieren  |https://github.com/Schmiddl99/experimenteverwaltung-i2/issues/[#202] |C |3 |DUE:27.04.21 |{GM}
...
a|* Vor dem TSM 4 wurden von dem Team durch Kontakt der Benutzer des Systems Benutzerwünsche gesammelt und validier. Diese sollten dann im TSM 4 mit dem Kunden besprochen werden. 
...
* Durch starke Zusammenarbeit mit dem Coach und Herr Prof. Dr. Anke könnte die Situation besser verstanden und analysiert werden. 
...
* Das C4 Modell für UC01 wurde abgeschlossen und liegt in GitHub vor.
* Die Belegdokumente wurden den Änderungen des Kunden angepasst und liegen in GitHub vor. 
* Das EMS-System kann von allen Devolpern aufgerufen werden. 
...
* Ziel: LCA-Meilenstein - Ende der Elaboration Phase, wurde NICHT erreicht, Vorbereitungen für IOC Meilenstein wurde erreicht.
** *Get a more detailed understanding of the requirements:* Grundsätzlich verstanden. 
*** *Erfolgskriterien:* konnten zum Ende der Iteration verstanden und umgesetzt werden. Die Neupriorisierung wurde in der Vision festgehalten und die einzelnen Belegbestandteile wurde auch aufgabenspezifisch angepasst. 
** *Design, implement, validate, and establish the baseline for the architecture:* Zu weiten Teilen abgeschlosssen.
*** *Erfolgskriterien:* Die Wireframes wurden den Änderungen nach angepasst und vom Kunden validiert. Auf die Validierung eines Skelettsystems wurde verzichtet, da unsre Ziele ja auf einem vorhanden, funktionierenden und verwendeten Projekt aufbauen. Da aber einige TCs des Vorgängerteams noch nicht funktionieren und wir hier erst selektieren müssen, welche repariert oder entfernt werden müssen, sehen wir diesen Punkt noch nicht als abgeschlossen an.
...
*** Unsre Arbeitszeit ist begrenzt: Heißt wir Arbeiten nicht, bis das Projekt abgeschlossen ist, sondern bis die verfügbare Zeit aufgebraucht ist.
...
** Das C4 Modell für UC01 wurde abgeschlossen und liegt in GitHub vor. *Y*
...
* Die Funktion des Redeführes wurde abgeschafft, da bei einer Gruppengröße von vier Personen diese nicht benötigt wird. 
* Das fehlerhafte Verständnis der Agilen Software Entwicklung hat bei uns zwar viele Negative Gefühle ausgelöst und es wurde auch viel diskutiert, dennoch haben wir es durch unsren Professionalismus und durch das teilweise Einschreiten von Teammitgliedern geschafft die Iteration abzuschließen. 
