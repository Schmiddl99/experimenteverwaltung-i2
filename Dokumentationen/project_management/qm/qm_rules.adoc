...
Je besser die Rollen und Verantwortlichkeiten geklärt sind, desto einfacher lassen sich Aufgaben verteilen und erledigen. Jedoch sollte jeder dafür verantwortlich seien, dass Aufgaben bestmöglich gelöst werden.  
...
=== Verantwortung
Verantwortung bedeutet die Übernahme von schlechten sowie guten Ergebnissen einzugestehen und zu tragen. Wichtig ist hier, dass bei negativem Auftreten niemals jemanden die Schuld gegeben werden sollte. 
