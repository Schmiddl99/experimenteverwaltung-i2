...
Da während unsres Projekts die Corona-AHA Regeln gegolten haben, wurden auf physische Treffen komplett verzichtet. Die komplette Kommunikation lief über die Programme *Whatsapp* , *Discord* und *MS-Teams*.
...
| I02
|<<Iteration Plan 02: {project-name}, Iterationsplan 02>>
| 17.12.2020-31.12.2020

| I03
|<<Iteration Plan 03: {project-name}, Iterationsplan 03>>
