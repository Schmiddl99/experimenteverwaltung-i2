...
* *Shared Vision*: Diese OpenUP-Praktik verbessert die Akzeptanz des späteren Produktes durch alle Stakeholder. In unserem Fall strebten wir die Übereinstimmung über die https://github.com/Schmiddl99/experimenteverwaltung-i2/blob/main/Dokumentationen/requirements/vision.adoc[Vision] und die damit beschriebene Gelegenheit gemeinsam mit dem Themensteller an. Das Team konnte diese Übereinstimmung in https://github.com/Schmiddl99/experimenteverwaltung-i2/blob/main/Dokumentationen/project_management/iteration_plan03.adoc[Iteration I3] erreichen.
