...
Wir (Team I2) legen unserem Projekt das Vorgehensmodell Open Unified Process (OpenUP) zugrunde.
...
Weekly Scrums, Workshops für Teaminternen Wissensaustausch beschreiben
Wiki GitHub erwähnen?
