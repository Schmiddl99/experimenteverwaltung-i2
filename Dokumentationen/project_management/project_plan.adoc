...
//<<Dokumentationen\project_management\Rollenübersicht.adoc, Rollenübersicht>> Link haut nicht hin, vielleicht aber für PDF-Generierung relevant?

//xref:Rollenübersicht.adoc#Verantwortlichkeiten[Rollenübersicht]

Siehe *Rollenübersicht*
...
Das Team führt 14-tägige Iterationen durch. Wir nutzen ein modifiziertes https://github.com/Schmiddl99/experimenteverwaltung-i2/projects/3[Scrum-Board] auf GitHub für Planung und Steuerung jeder Iteration. Iterationen werden in ALLEN Phasen des Projektes generell mit der Klassifizierung I1, I2, ... I[n] benannt. Dafür haben wir uns entschieden, da die OpenUP-Meilensteine nicht zwangsweise am Ende einer Iteration, sondern während der Arbeit erreicht wurden, was eine Aufteilung in I-, E-, C- und T-Phasen erschwerte.
...
Das Ende einer jeden Iteration wird mit einer *Review* und einer *Retrospective* abgeschlossen. Dabei ist das gesamte Team einzubeziehen!
...
*** Der erste Workshop zum Thema "GitHub" wurde am 21.12.2020 von Richard und Gregor durchgeführt (Siehe *I02*)
...
* *Shared Vision*: Diese OpenUP-Praktik verbessert die Akzeptanz des späteren Produktes durch alle Stakeholder. In unserem Fall strebten wir die Übereinstimmung über die *Vision*
//Link!!
und die damit beschriebene Opportunity gemeinsam mit dem Themensteller an. Das Team konnte diese Übereinstimmung in *Iteration I03*
//Link Iteration Plan!!
erreichen.

* *Use Case Driven Development*: OpenUP empfiehlt die Zugrundelegung eines *Use Case Models* 
//Link!!
sowie von *System-Wide Requirements*
//Link!!
zur Beschreibung, Gliederung und Auswertung der erhobenenen Anforderungen. Durch die Nutzung dieser Praktik versprechen wir uns eine efizientere Umsetzung und ein höheres Erfolgspotential des gesamten Projektes.
...
| I02
| siehe *Iterationsplan I02*
//<<Dokumentationen\project_management\iteration_plan_02.adoc, Iterationsplan 02>> 
//xref:iteration_plan_02.adoc#Meilensteine[Iterationsplan 02]
//Link testen!!
| 17.12.2020-31.12.2020

| I03
| siehe *Iterationsplan I03*
//<<Dokumentationen\project_management\iteration_plan_03.adoc, Iterationsplan 03>> 
//xref:iteration_plan_03.adoc#Meilensteine[Iterationsplan 03]
| 07.01.2021-21.01.2021

| I04
| * Domänenmodell
* Überarbeitung der Use Cases
* Überarbeitung der Test Cases
* Anfertigung des Beleges für das Modul: Überprüfung der Dokumente (siehe *QM*)
//Link!!
...
* Übertragung des Systems von der VM auf den regulären Fakultätsserver durch TAVM
