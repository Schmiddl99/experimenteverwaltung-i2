...
| I07
a| * Implementierung und Durchführung von <<Test Cases für Use Case "Experiment buchen": {project-name}, Test Cases für Use Case "Experiment buchen">>
* Implementierung von Use-Case: <<Dozentenwoche ansehen: {project-name}, Dozentenwoche ansehen>>
* Belegverbesserungen und Belegupdates
* Erstellung von UC10 Link!!!!
* Analyse und Reperatur von alten TCs abgeschlossen Link !!!
