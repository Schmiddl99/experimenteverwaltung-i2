...
Tim Würzburg (SE I) <email@domain.org> - Tobias Karsch (SE I) <s79375@htw-dresden.de> - Gregor Müller (SE II) <email3@domain.org>
...
Der Projektplan umfasst die vier Phasen:
