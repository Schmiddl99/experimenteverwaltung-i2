...
Dieses Dokument beschreibt die Philosophie, Nebenbedingungen, Begründungen, wesentliche Elemente und andere übergreifende Aspekte, die Einfluss auf Entwurf und Implementierung bezüglich der Realisierung eines in der link:../requirements/vision.adoc[Vision] beschriebenen Buchungssystems für Physikexperimente haben.
...
Über die Systemweiten funktionalen und nichtfunktionalen Anforderungen kann im link:../requirements/system-wide_requirements.adoc[Anforderungsdokument] nachgelesen werden. 

[cols="1,1,2"] 
|===
|Anforderung |Systemkomponente |Architekturmechanismen

|link:../requirements/use_case_01.inc.adoc[UC01]
a|   * Webanwendung
     * Weboberfläche 
     * Datenbank 
     * Experiment
...
|link:../requirements/use_case_01.inc.adoc[UC03]
a|   * Webanwendung
     * Weboberfläche 
     * Buchung
     * Datenbank 
...
|link:../requirements/use_case_01.inc.adoc[UC05]
a|   * Webanwendung
     * Weboberfläche 
     * Buchung
     * Datenbank 
...
.. Grund: Arbeitserleichterung des Nachfolgerentwicklerteams 
...
* [.underline]#Funktion#: z.B. zw. DB/Buchungssystem 

. **Error Management **
* [.underline]#Zustand#: Problem 
...
* [.underline]#Funktion#: Rails und der Webservice geben bei einem unerwarteten Fehler eine Standart-Fehlerseite aus 
...
** Kann auch  Kommentare  im Quellcode beschreiben (zw. Entwicklerteams) 

. **Kompatibilität **
* [.underline]#Zustand#: Problem 
* [.underline]#Zweck#: System muss auf allen erwähnten Browsern funktionieren 
...
* **Klasse Experiment:** Teil der Buchung - Das Objekt wird beim Buchungsvorgang aus der Datenbank bezogen. Das Objekt wird in Dozentenwoche angezeigt.
* **Klasse Nutzer (Vererbung):**
...
* **Klasse Buchung:** Wird vom Dozenten erstellt. Beinhaltet ein oder mehrere Experimente. Besitzt zusätzliche Daten.
...
* **Model**  = Schicht der Geschäftslogik und ihrer Anwendung 

    image:Dokumentationen\requirements\images\domain_model.svg:domain_model.svg[]
...
.Context-Diagramm
image::context_diagram.png[Kontext-Diagramm]
.Context-Diagramm - Legende 
image::context_legend.png[Kontext-Legende]
