...
. Weiterverwendung des bis jetzt genutzen Test-Frameworks und der bis jetzt existierenden (teilweise fehlerhaften) Testcases und damit einherkommende Fehlerbehebung
.. Grund: zu hoher Mehraufwand durch Einarbeitung in neues Framework und erneutes Schreiben der Alttests
