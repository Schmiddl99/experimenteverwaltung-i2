...
Über die Systemweiten funktionalen und nichtfunktionalen Anforderungen kann im <<System-Wide Requirements: {project-name},Anforderungsdokument>> nachgelesen werden. 
...
* **Model**  = Schicht der Geschäftslogik und ihrer Anwendung (siehe <<Domain Model: {project-name}, Domain-Modell>>)
