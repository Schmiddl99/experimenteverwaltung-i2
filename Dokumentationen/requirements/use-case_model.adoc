...
Um eine einfache Übersicht über die Use Cases zu erlangen, wurde ein BPMN Diagramm erstellt, welches alle Use Cases darstellt sowie ein UML Diagramm, um die einzelnen Beziehungen der User auf die Use Cases aufzuzeigen. 
