...
Wenn in der ausgewählte Woche des Dozenten keine Buchungen existierten wird eine Meldung ausgegeben, die beinhaltet, dass keine Buchnungen vorhanden sind. 
