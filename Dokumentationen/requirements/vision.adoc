...
** einheitliche Größe der drei Side Bar Buttons während einer Buchung umsetzen
** "Buchung abrrechen"-Button soll rot werden
...
* bei Zeitraumauswahl für die Dozentenwochenansicht soll standardmäißg die nächste Kalenderwoche angezeigt werden
