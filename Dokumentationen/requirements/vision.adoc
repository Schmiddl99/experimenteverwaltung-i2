...
* Warenkorb-System: Experimente können über Button in Warenkorb gelegt werden 
* Im Warenkorb kann benötigtes Datum des Experiments hinterlegt werden 
* Journal-System: Dozenten können bis ihre Buchungen einsehen und bis zu einer bestimmten Deadline Änderungen/Stonierungen vornehmen 
* Wochenplan-System: Bereitstellung einer Buchungs-Einsicht  mit bspw. einer Excel Datei, in welcher die Buchungen mit Sortierung je Wochentag aufgelistet, einfache und Übersichtliche Gliederung 
...
|Unser Produkt|	… ermöglicht die einfache Bestellung und Bestellanpassung von Experimenten und Generierung eines Wochenplans der Buchungen dieser sowie eine Übersicht der bisherigen Buchungen.
|===
...
|Journal einsehen |hoch |eigene Buchungen einsehen und u.U. Anpassungen vornhemen  |xx
