...
* Warenkorb-System: Experimente können nach Festlegung der Voreinstellungen über Button in Warenkorb gelegt werden, wo sie angepasst und ins Journal geschickt werden können
* Journal-System: Buchungsübersicht des Dozenten, wo er alle vergangenen Buchungen einsehen, die aktuellen anpassen und Buchungen kopieren kann  
