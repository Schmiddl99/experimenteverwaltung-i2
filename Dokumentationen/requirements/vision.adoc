...
Der Zweck dieses Dokuments ist es, die wesentlichen  an das System gestellten Anforderungen aus Sicht der künftigen Anwender zu beschreiben. Die Begrifflichkeiten sind an die Bedüfnisse und den Sprachgebrauch der Anwender angepasst.
