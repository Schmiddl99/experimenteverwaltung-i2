...
|Login |Hoch | Benutzerverwaltung der einzelnen Anwender | xx
|Experimentfeld-Geräte Anpassung | Mittel |Ansicht der Geräte für Experimente übersichtlicher gestalten | xx
|Statistik ansehen |Mittel |Statistik, als Overlay bei der Experimente-Auswahl, der (bestellten) Experimente einsehen |xx
|Verwaltung der Bilder |Niedrig |Bilder in Experimenten können ersetzt werden, Reihenfolge wird einbehalten |xx
|Bugfix bei Experimentfeld-Gefahren | Niedrig | Bei der Anzeige von Textfeldern werden diese ineinander geschoben, dies soll behoben werden | xx
