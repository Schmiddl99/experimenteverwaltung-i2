...
Um diesen Mehraufwand zu umgehen, möchte der Kunde eine Möglichkeit der Hinzufügung von Experimenten in einen “Warenkorb”. In diesem soll je Experiment ein Datum hinterlegt werden und als Auftrag bestellt werden können. Am Ende der Woche sollen dann automatisiert diese Daten abrufbar gemacht werden, aufbereitet zur einfachen Planung der Bestellungen je Wochentag pro Dozent. 

Ebenfalls soll die Möglichkeit einer Auswertung der vergangenen Bestellungen ermöglicht werden. Dies ist wichtig, um herauszufinden welche Experimente besonders oft gebucht werden, um bspw. Verschleiß der Geräte vorauszusagen und in Folge dessen mehr Geräte oder Instrumente einzukaufen. Diese Historie dient außerdem dem Zweck der Ermöglichung des Kopierens von wiederauftretenden  Buchungsabfolgen in Folgesemestern. 
...
* Warenkorb-System: Experimente können nach Festlegung der Voreinstellungn über Button in Warenkorb gelegt werden, wo sie angepasst und ins Journal geschickt werden können
* Journal-System: Buchungsübersicht des Dozenten, wo er alle Buchungen einsehen und die aktuellen anpassen kann 
...
* Dozenten:  
** … Experimente für die kommenden Vorlesungen bestellen wollen 
* Admin: 
** ... einsehen wil, welche Experimente bestellt wurden. 
...
|Unser Produkt|	… ermöglicht die einfache Bestellung von Experimenten und Generierung eines Buchungsplans, sowie eine Übersicht der bisherigen Buchungen.
|===
...
|Kopierung |hoch |Übernahme von Buchungssätzen in Folgesemester| xx 
