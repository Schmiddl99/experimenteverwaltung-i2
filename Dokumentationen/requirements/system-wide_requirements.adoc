...
* Eine etwaige Datenschutzerklärung muss vor der Registration vorliegen und vor der Nutzung durch Dozenten anerkannt werden. Der Verantwortliche hierbei sollte der Admin sein. 
