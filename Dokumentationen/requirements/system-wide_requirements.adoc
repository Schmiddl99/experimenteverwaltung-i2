...
* *SWFA-1*: Das System muss Zugriffsbeschränkungen gewährleisten. 

** *SWFA-1.1*: Dafür ist eine Zuordnung aller Anwender zu Rollen notwendig. 
//Link zum Glossar

** *SWFA-1.2*: Weiterhin muss gewährleistet werden, dass jeder Anwender nur auf die ihm/ihr zugeordneten Daten Zugriff hat.  

** Überprüfbar wird dies durch Test-Log-Ins, anhand welcher vesucht wird auf fremde Daten und Rollenfunktionalitäten zuzugreifen. 
...
* *SWFA-3*: Das System muss Zugangsdaten der Anwender schützen. 
...
** *NFAU-1.1*: Die Anzahl Interaktionselementen soll komprimiert sein.  
...
*** Es soll vorgefertigte Drop-Down Menüs und Widgets zur Auswahl aus festgelegten Wertebereich geben. Zur Überprüfung wird getestet, ob invalide Eingaben möglich sind. 
...
*** Zur Überprüfung wird eine Testperson die Anwendung mit einem Abstand von 50cm Entfernung zum Bildschrim nutzen. 
...
* *NFAR-1*: Die Nutzbarkeit muss gewährleistet sein, wenn alle derzeitigen Anwender gleichzeitig arbeiten wollen. 
...
* *NFAS-2*: Die Software muss auf folgende Browser funktionieren: 
** Edge 
** Internet Explorer (Version 11) 
** Chrome
** Firefox 
** Zur Überprüfung muss die Anwendung in allen Browsern getestet werden. 
