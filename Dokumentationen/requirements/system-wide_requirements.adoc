...
*** Es soll vorgefertigte Drop-Down Menüs und Widgets zur Auswahl aus festgelegten Wertebereichen geben. Zur Überprüfung wird getestet, ob invalide Eingaben möglich sind. 
