...
|Experiment
a|* Ein Experiment ist eine Veranschulichung inerhalb einer Physikvorlesung 
* Es behinhaltet alle Informationen die zur Durchführung nötig sind 

|Experimentefeld
a|* Bei jedem Experiment gibt es die Möglichkeit Zusatzinforamtionen hinzufügen
...
* Es wird zusätzlich teschnische Informationen enthalten die den Update Prozess von Ruby on Rails beschreibt
|
