...
== Use-Case: *eigene* Dozentenwoche ansehen und drucken
===	Kurzbeschreibung
Dozent möchte sich Wochenplan (Übersicht von allen eigenen Exp. inkl. Details) für bestimmte KW anzeigen lassen
...
* Dozent muss eingeloggt sein
* Dozent muss Wochenplanansicht aufgerufen haben

=== Standardablauf (Basic Flow)
//Der Standardablauf definiert die Schritte für den Erfolgsfall ("Happy Path")

. Der Use Case beginnt, wenn Dozent die Wochenplanansicht aufruft
