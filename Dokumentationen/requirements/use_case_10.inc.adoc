...
. User bestätigt die Reaktivieren druch erneuten Druck auf das Icon, nachdem er durch Benachrichtigung darauf hingewiesen wurde. Hierdruch wird der Studiengang zurück in die Studiengangsübersicht verschoben. 
