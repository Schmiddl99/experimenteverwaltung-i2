...
. Im Checkout werden die aktuellen Buchungen aufgezählt, mit Möglichkeit zur Löschung und Kommentierung jeder Buchung. Auch ist es möglich die Reihenfolge der Experimente mit Drag and Drop zu ändern und durch klicken auf den Button "manuel Experiment hinzufügen" kann ein Expermint außerhalb der Datenbank hinzugefügt werden.
